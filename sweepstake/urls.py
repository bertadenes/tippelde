...
urlpatterns = [
    ...
    url(r'^guess_delete/(?P<pk>\d+)/$', views.Bet_delete.as_view(template_name='confirm_delete.html'),
        name='delete_guess'),
    url(r'^sq_delete/(?P<pk>\d+)/$', views.SQDel.as_view(template_name='confirm_delete.html'),
        name='delete_sq'),
    url(r'^sa_delete/(?P<pk>\d+)/$', views.SADel.as_view(template_name='confirm_delete.html'),
        name='delete_sa'),
